window.onload = function () {
    var container =  document.getElementById("index-container-slide");
    var banner = document.getElementById("index-banner-slide");
    var li = document.querySelectorAll("#index-banner-slide li");
    var spanNode = document.querySelectorAll("#index-buttons-slide span");
    ...
    next.onclick = function () {
        ...
        index ++;
        console.log("index:"+index);//索引index
    ...
    function showButton() {
        ...
        console.log("spot's index："+index);//小圆点的index值
